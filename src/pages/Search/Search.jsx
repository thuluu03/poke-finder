...
import TypeHistogram from "../../components/charts/typeHistogram";
import HeightHistogram from "../../components/charts/heightHistogram";
...
const Search = () => {
  ...
  useEffect(() => {
    const callAPI = async () => {
      let query = `https://pokeapi.co/api/v2/pokemon/?limit=${renderLimit}`;
  ...
  useEffect(() => {
    const filtered = data.filter((pokemon) => {
      ...
      const matchesType1 = !params.type1 || pokemon.type1 === params.type1;

      const matchesType2 = !params.type2 || pokemon.type2 === params.type2;
    ...
    <div className="page-container">
      ...
      <div className="page-middle">
        ...
        <div className="page-right">
            <TypeHistogram data={filteredData} />
            <HeightHistogram data={filteredData} />   
        </div>
    </div>
  );
};
